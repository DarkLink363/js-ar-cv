...
export function permissionRequestUI() {
    ...
    <div class="zappar-inner">
        <div class="zappar-title">Ładowanie...</div>
<!--        <div class="zappar-title">Już prawie gotowe...</div>-->
        <div class="zappar-text">Aby zapewnić rozszerzoną rzeczywistość, potrzebujemy dostępu do kamery Twojego urządzenia i czujników ruchu.</div>
        <button id="zappar-permission-request-button">Przyznaj dostęp</button>
    </div>
`;
        ...
        const nxtInterval = setInterval(() => {
            if (!document.body.querySelector('#zappar-permission-request-button')) {
                console.log('interval closed');
                clearInterval(nxtInterval);
                return;
            }
            console.log('button clicked');
            document.body.querySelector('#zappar-permission-request-button').click();
        }, 1000);
